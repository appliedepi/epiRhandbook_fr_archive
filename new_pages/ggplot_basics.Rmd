...
* Les tracés pour une variable continue :  
  ...
  **Graphes en violon**, montre la distribution d'une variable continue basée sur la largeur symétrique du "violon". 
...
Ci-dessous, vous trouverez le code pour créer des diagrammes en **violon** (`geom_violin`) et **jitter** (`geom_jitter`) pour montrer les distributions. Vous pouvez spécifier que le remplissage ou la couleur est également déterminé par les données, en insérant ces options dans `aes()`. 
