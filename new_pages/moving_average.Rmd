...
Si vous avez des séries temporelles propres avec des valeurs pour chaque date, vous pouvez utiliser `slide_dbl()`, comme démontré ici dans la page [Série chronologique et détection des épidémies](#timeseries_moving).  
