...
linelist[age >= 18 & hospital != "Central Hospital"] #subset les cas égaux ou supérieurs à 18 ans mais non diagnostiqués à l'hôpital central
...
* filtrons les lignes où le résultat est "Récupération" ou "Décès".
* filtrons les lignes dans la tranche d'âge 40-60 ans

``{r, eval=F}
linelist[hospital %like% "Hospital"] #filtre les lignes où la variable hospital contient âHospitalâ
...
### Calcul sur les colonnes {.unnumbered} (non numérotées) 
...
````{r}
linelist[, .N, .(hôpital)] #le nombre de cas par hôpital
linelist[age > 18, .(mean_wt = mean(wt_kg, na.rm = T),
                             mean_ht = mean(ht_cm, na.rm = T)), .(gender, outcome)] #Les na.rm représentent les catégories où les données sont manquantes
...
linelist[, adult := âge >= 18] #ajoute une colonne
