...
Ci-dessous, nous présentons un épicurve de base qui a été transformé pour être interactif en utilisant l'intégration de **ggplot2** et **plotly** (passez votre souris sur le graphique, faites un zoom ou cliquez sur les éléments de la légende). 
...
```{r, eval=F}
# importez les cas linelist_cleaned
...
deaths_plot <- ggplot(data = weekly_deaths)+            # commencer par les données hebdomadaires des décès 
  geom_line(mapping = aes(x = epiweek, y = pct_death))  # faire la courbe  
