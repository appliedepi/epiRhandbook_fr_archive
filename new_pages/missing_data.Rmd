...
Les valeurs impossibles sont représentées par le mot spécial `NaN`. Par exemple, R renvoit `NaN` si vous ui demandez de diviser 0 par 0. `NaN` peut être évalué avec `is.nan()`. Il existe également des fonctions complémentaires comme `is.infinite()` et `is.finite()`. 
