...
1) Evaluer l'ampleur des données manquantes  
...
Pour évaluer les données manquantes dans un dataframe en *stratifiant par une autre colonne*, on peut utiliser la fonction `gg_miss_fct()`, qui retourne une carte thermique du pourcentage de valeurs manquantes dans le dataframe *par un facteur/colonne catégorique (ou date)* :  
