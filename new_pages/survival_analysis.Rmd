...
Parmi ces éléments, il y en a un important : `cumhaz`, qui est un vecteur numérique. Il pourrait être tracé pour permettre de montrer l'**_aléa cumulatif_**, l'**_aléa_** étant le **_taux instantané d'occurrence de l'événement_** (voir références).
