...
façons de le faire (voir la page [Manipuler les dates](#working_dates))
...
fonctionner. Le site Web du paquet contient un [demo utile](https://github.com/bluegreen-labs/ecmwfr#use-copernicus-climate-data-store-cds)
