...
Pour afficher cette sortie de comptage par groupe avec `ggplot()`, c'est relativement simple. Voir d'autres exemples dans les pages [Tracer des données catégorielles] et [Trucs et Astuces avec ggplot](#ggplot_tips).  
