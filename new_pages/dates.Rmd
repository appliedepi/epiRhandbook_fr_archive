...
* `last_date` - la derniére date valide (la valeur par défaut est la date du jour)  
* `first_date` - la premiére date valide. La valeur par défaut est de cinquante ans avant la derniére date. 
