...
Voir la page [Download handbook and data] pour savoir comment télécharger tous les exemples de données du manuel. Vous pouvez importer les données de la page de normalisation directement dans R depuis notre dépôt Github en exécutant les commandes `import()` suivantes :  
...
<!-- ======================================================= -->
### Taux standardisés {.non numéroté}
...
Consultez l'aide de `?phr_dsr` ou les liens dans la section Références pour plus d'informations.  
...
Consultez l'aide de `?phr_isr` ou les liens dans la section Références pour plus d'informations.  
